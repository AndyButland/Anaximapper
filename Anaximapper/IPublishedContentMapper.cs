namespace Anaximapper
{
    ...
    public interface IPublishedContentMapper
    {
        /// <summary>
        ...
        IPublishedContentMapper AddCustomMapping(
        ...
        /// <param name="propertySet">Set of properties to map</param>
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper Map<T>(IPublishedElement content,
            T model,
            string culture = "",
            Dictionary<string, PropertyMapping> propertyMappings = null,
            PropertySet propertySet = PropertySet.All)
        ...
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper Map<T>(XElement xml,
            T model,
            Dictionary<string, PropertyMapping> propertyMappings = null)
            where T : class;
        ...
        /// <param name="propertyMappings">Optional set of property mappings, for use when convention mapping based on name is not sufficient</param>
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper Map<T>(Dictionary<string, object> dictionary,
            T model,
            string culture = "",
            Dictionary<string, PropertyMapping> propertyMappings = null)
            where T : class;
        ...
        /// <param name="propertyMappings">Optional set of property mappings, for use when convention mapping based on name is not sufficient</param>
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper Map<T>(string json,
            T model,
            Dictionary<string, PropertyMapping> propertyMappings = null)
            where T : class;
        ...
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper MapCollection<T>(IEnumerable<IPublishedContent> contentCollection,
        ...
        /// <param name="clearCollectionBeforeMapping">Flag indicating whether to clear the collection mapping too before carrying out the mapping</param>
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper MapCollection<T>(IEnumerable<IPublishedElement> contentCollection,
            IList<T> modelCollection,
            string culture = "",
            Dictionary<string, PropertyMapping> propertyMappings = null,
            PropertySet propertySet = PropertySet.All,
        ...
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper MapCollection<T>(XElement xml, IList<T> modelCollection,
            Dictionary<string, PropertyMapping> propertyMappings = null,
        ...
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper MapCollection<T>(IEnumerable<Dictionary<string, object>> dictionaries,
            IList<T> modelCollection,
            string culture = "",
            Dictionary<string, PropertyMapping> propertyMappings = null,
            bool createItemsIfNotAlreadyInList = true,
        ...
        /// <returns>Instance of IUmbracoMapper</returns>
        IPublishedContentMapper MapCollection<T>(string json, IList<T> modelCollection,
            Dictionary<string, PropertyMapping> propertyMappings = null,
